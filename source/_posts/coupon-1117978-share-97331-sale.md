---
title: Share Coupon Code Of Gshopper - SONOFF BasicR2 Wireless WIFI Remote Control Timing Switch
date: 2024-09-04T12:21:40.431Z
updated: 2024-09-05T12:21:40.431Z
categories:
...
<main class="px-4 py-6 sm:p-6 md:px-8 md:py-10">
  <div class="mx-auto grid max-w-4xl grid-cols-1">
    <div class="relative col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradient-to-t from-black/75 via-black/0 p-3 sm:row-start-2 sm:bg-none sm:p-0 lg:row-start-1">
      <h1 class="mt-1 text-lg font-semibold text-white sm:text-slate-900 md:text-2xl dark:sm:text-white">SONOFF BasicR2 Wireless WIFI Remote Control Timing Switch</h1>
    </div>
      ...
      <dd class="flex items-center text-indigo-600 dark:text-indigo-400">
        ...
        <span>4.96 <span class="font-normal text-slate-400">(33.33k)</span></span>
      </dd>
