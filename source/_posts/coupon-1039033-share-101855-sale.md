...
date: 2024-09-04T12:02:10.225Z
updated: 2024-09-05T12:02:10.225Z
categories:
  ...
  <div class="mx-auto grid max-w-4xl grid-cols-1 lg:max-w-5xl lg:grid-cols-2 lg:gap-x-20">
    <div class="relative col-start-1 row-start-1 flex flex-col-reverse rounded-lg bg-gradient-to-t from-black/75 via-black/0 p-3 sm:row-start-2 sm:bg-none sm:p-0 lg:row-start-1">
      ...
      <dd class="flex items-center text-indigo-600 dark:text-indigo-400">
        ...
        <span>5.00 <span class="font-normal text-slate-400">(26.75k)</span></span>
      </dd>
    ...
    <p class="col-start-1 mt-4 text-sm leading-6 sm:col-span-2 lg:col-span-1 lg:row-start-4 lg:mt-6 dark:text-slate-400">$15 discount for orders over $600 Keywords: NEJE MAX 4 LASER ENGRAVER,NEJE 3 LASER ENGRAVER,NEJE MAX 4,NEJE MAX 4 E80,NEJE E80,NEJE A40640,NEJE E40,NEJE MAX 4 A40640,NEJE MAX 4 E40,NEJE 3 MAX V2,NEJE 3 MAX E40,NEJE 3 MAX E80</p>
    <p class="mt-4">
      <code class="bg-purple-900 p-4 text-sm font-bold tracking-widest text-white">NS35</code>
    </p>
  </div>
</main>
